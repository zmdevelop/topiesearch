...
<body>
									...
									<div class="portlet-title">
										<div class="caption caption-md">
											<i class="icon-bar-chart theme-font hide"></i> <span
												class="caption-subject theme-font bold uppercase">视频类型</span>
					...
					<div class="col-md-9 col-sm-12">
						...
						<div class="portlet light">
							<div class="portlet-title">
								<div class="caption caption-md">
									<i class="icon-bar-chart theme-font hide"></i> <span
										class="caption-subject theme-font bold uppercase">视频管理</span>
									<span class="caption-helper"></span>
								</div>
							</div>
							<div class="portlet-body" id="video_grid"></div>
						</div>
						<!-- END PORTLET-->
					</div>
				</div>
    ...
    var root = '<%=basePath%>'
		...
		function initMediaTypeTree() {
			...
			mediaTypeTree.setting.async.url = "../../dict/dictItems/1";
			...
			actionCloums : [
					{
						...
						handle : function(index, data) {
							...
							form.loadRemote("./load?videoId=" + data.id);
						}
					}
					/* , {text:"排序",
						cls:"yellow",
		...
		jQuery(document).ready(function() {
			initMediaTypeTree();
			grid = $("#video_grid").dmGrid(options);
		});
	</script>
	<!-- END JAVASCRIPTS -->
</body>
