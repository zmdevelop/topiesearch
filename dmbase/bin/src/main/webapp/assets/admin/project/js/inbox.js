...
(function($, window, document, undefined) {
	...
	var fileTmpl = '<tr class="template-upload fade in">'
			...
			+ '<span class="preview"><img src="" width="46" height="40"/></span>'
			+ '</td>' + '<td style="vertical-align: middle;width:15%;">'
	...
	var initContacts = function() {
		...
		var dropDown = $('<ul class="dropdown-menu pull-right" role="menu"><li><ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283"></ul></li></ul>');
		$
				.ajax({
					type : "POST",
					dataType : "json",
