...
public class ZipCompressor {
    ...
    public static void main(String[] args) {
        ZipCompressor zc = new ZipCompressor("E:/test/test.zip");
        zc.compress("D:\\IDEA\\app\\target\\dmbase-0.0.1-SNAPSHOT\\新建文件夹",
            "D:\\IDEA\\app\\target\\dmbase-0.0.1-SNAPSHOT\\新建文件夹 2");
    }
}
