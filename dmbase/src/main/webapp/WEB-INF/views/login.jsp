...
<div class="logo">
    <%-- <a href="#"> <img
            ...
            <div style=""><n style="font-size: 23px; color: blue;">TOPIE</n><m style="font-size: 24px; color: rgb(197, 11, 11);font-family: &#39;comic sans ms&#39;"">SEARCH</m>
			</div>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
